      ...
      <li class="nav-item">
       ...
       <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="utilities-animation.php">Ajouter Catégorie</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="blank.php">Ajouter Produit</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
         ...
         <!-- Page Heading -->
          <h1 class="h3 mb-1 text-gray-800">Affichage Catégorie</h1>
...
<center>
                           <form method="POST" action="pdf1.php">
                                ...
                                <input type="hidden" value="<?PHP echo $row['idC']; ?>" name="id">
                            </form>
                            </div>
